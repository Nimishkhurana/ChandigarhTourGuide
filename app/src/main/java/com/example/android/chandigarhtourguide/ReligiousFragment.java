...
public class ReligiousFragment extends Fragment {
    ...
    private String[] names = new String[]{"Elante Mall",
            "Rock Garden","Sukhna Lake","Chandi Mandir","Panjab University","Clubs"};

    private int[] thumbnail = new int[]{
            R.drawable.elante,R.drawable.elante,R.drawable.elante,R.drawable.elante,R.drawable.elante,R.drawable.elante
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle(R.string.religious_places);
